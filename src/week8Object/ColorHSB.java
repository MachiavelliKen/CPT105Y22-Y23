...
public class ColorHSB {
    ...
    public int squareDist(ColorHSB that) {
        int a=Math.min((this.hue-that.hue)*(this.hue-that.hue),(360-Math.abs(this.hue- that.hue))*(360-Math.abs(this.hue- that.hue)));
        int b=(this.saturation- that.saturation)*(this.saturation- that.saturation);
        int c=(this.brightness- that.brightness)*(this.brightness- that.brightness);
        return a+b+c;
